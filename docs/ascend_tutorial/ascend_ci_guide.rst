...
+---------------------------------------+-------------------------------------------------------------------+
| Qwen2___5-3B-Instruct-GPTQ-Int4       | ``${HOME}/.cache/models/Qwen/Qwen2___5-3B-Instruct-GPTQ-Int4``    |
+---------------------------------------+-------------------------------------------------------------------+
| Qwen2.5-0.5B                          | ``${HOME}/.cache/models/Qwen/Qwen2.5-0.5B``                       |
+---------------------------------------+-------------------------------------------------------------------+
| Qwen2.5-0.5B-Instruct                 | ``${HOME}/.cache/models/Qwen/Qwen2.5-0.5B-Instruct``              |
+---------------------------------------+-------------------------------------------------------------------+
| Qwen2___5-7B-Instruct                 | ``${HOME}/.cache/models/Qwen/Qwen2___5-7B-Instruct``              |
+---------------------------------------+-------------------------------------------------------------------+
...
* **资源管理**：一个workflow里的多个job为并行运行，请合理设置超时时间，避免任务长时间挂起，请控制单个 job 的运行时间在 40min 以内。如CI因排队等待超时1h, 会自动取消，请重新触发运行。
